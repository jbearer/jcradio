...
TODO
    ...
    Features
        ...
        Recommendations
            ...
            Prepoulate text with your next letter
            Add options for
                Random song I played
            Errors if
                you don't have any seeds
                it can't find any results
                you put a bad first letter in
            Encorporate genre seeds?
            Button to add to queue
            Put final result in some sort of box
            Show list of final candidates
